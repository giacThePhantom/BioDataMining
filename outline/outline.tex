...
Then by the means of a statistical analysis we will obtain a dataset of differential expressed genes in different stages of colorectal cancer and a dataset of vitamin D gene signature.
